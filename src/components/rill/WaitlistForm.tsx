    ...
    <form className={`waitlist-form-stack waitlist-form-stack--${variant}`} onSubmit={onSubmit} noValidate>
      ...
      <div className="waitlist-consent">
        ...
        <label htmlFor={`consent-${source}`}>
          I agree to receive launch updates and marketing from Meora. I understand that this waitlist is not a medical consultation or request for treatment and joining does not guarentee eligibility. View our{" "}
